...
public class StudentMinHeapTest {
	...
	private Heap<Integer>  heapPar(){
		Heap<Integer> heap = new HeapImpl<Integer>(new ComparatorMinHeap<Integer>());
	...
	public void testBuild1(){
		...
		Heap<Integer> heap1 = new HeapImpl<Integer>(new ComparatorMinHeap<Integer>());
		Heap<Integer> heap2 = new HeapImpl<Integer>(new ComparatorMinHeap<Integer>());
		Heap<Integer> heap3 = new HeapImpl<Integer>(new ComparatorMinHeap<Integer>());
		Heap<Integer> heap4 = new HeapImpl<Integer>(new ComparatorMinHeap<Integer>());
		Heap<Integer> heap5 = new HeapImpl<Integer>(new ComparatorMinHeap<Integer>());
